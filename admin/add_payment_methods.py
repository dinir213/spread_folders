...
async def view_all_payment_methods(call: types.CallbackQuery):
    await call.message.edit_caption(f"Включить способы оплаты можно путем нажатия на кнопку ниже с его названием", reply_markup=(await create_kb_payment_methods()))
